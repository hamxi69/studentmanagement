...
if (isset($_GET['uid'])) {
  ...
  echo "The uid parameter is not set.";
  exit;
}
if (isset($_POST['update_user'])) {
  ...
  $query = "UPDATE users SET Name='$fullName', u_name='$u_name', Email='$email' WHERE id=$user_id";
  $result=mysqli_query($conn, $query);
  if (!$result) {
    echo "Error updating record: " . mysqli_error($conn);
  } else {
    header("Location: usersprofile.php?uid=$user_id");
  }
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="usersprofile.php?uid=<?=$user_id?>">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="usersprofile.php?uid=<?=$user_id?>">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">School Demo</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Purani Sabi Mandi</div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="" method="Post">
                    ...
                    <div class="row mb-3">
                      <label for="u_name" class="col-md-4 col-lg-3 col-form-label">User Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="u_name" type="text" class="form-control" id="u_name" value="<?=$row['u_name']?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="company" type="text" class="form-control" id="company" value="IntelySol Solutions" readonly>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="country" type="text" class="form-control" id="Country" value="Pakistan" readonly>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="address" type="text" class="form-control" id="Address" value="Purani Sabzi Mandi" readonly>
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                      <button type="submit" name="update_user" value=<?=$user_id?> class="btn btn-primary">Save Changes</button>
                    </div>
...
if (isset($_POST['changepassword'])) {
  ...
  if ($newpassword != $renewpassword) {
    echo '<script>document.getElementById("error_message").innerHTML = "New passwords do not match.";</script>';
     ?>
    <script>
...
<?php
    ...
    if (password_verify($password, $hashed_password)) {
      ...
      if (mysqli_query($conn, $update_query)) {
        echo '<script>document.getElementById("error_message").innerHTML = "Password updated successfully.";</script>';
      } else {
        echo '<script>document.getElementById("error_message").innerHTML = "Error updating password.";</script>';
      }
    } else {
      echo '<script>document.getElementById("error_message").innerHTML = "Incorrect current password.";</script>';
    }
  }
}
