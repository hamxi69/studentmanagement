...
<?php
  if(isset($_SESSION['classadd'])){
    echo "<div id='msg' class='alert alert-success  align-items-center' style='float:right;'>
            ...
            <strong>".$_SESSION['classadd']."</strong>
            </div>";
...
<!--------- End Add Dialog Modal Msg --------->

<!--------- Edit Dialog Modal Msg--------->
<?php
   if(isset($_SESSION['classedit'])){
    ...
    <strong class='text-dark'>".$_SESSION['classedit']."</strong>
      ...
      unset($_SESSION['classedit']);
  }
  ?>


<!--------- End Edit Dialog Modal Msg--------->

<!---------  Delete Dialog Modal Msg--------->
<?php
  if($delete==true){
    echo "
          ...
          <strong class='text-dark'> Class Deleted ID is: ".$id."</strong>
...
<!--------- End Delete Dialog Modal Msg--------->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title fs-5" id="exampleModalLabel">ADD NEW CLASS</h5>
      ...
      <div class="col-md-5">
    <label for="classname1" class="form-label" >Class Name</label>
    <input type="text" class="form-control center"  name="classname" id="classname1" placeholder="Class Name" required>
  ...
  <div class="col-md-12 ">
    <button type="submit" name="addclassname" class="btn btn-outline-primary ">Submit</button>
  </div>
  ...
  <?php
                //select database data show in table    
                    $select_data="SELECT * FROM `classname`";
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title fs-5" id="exampleModalLabel">Edit Class Name</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
