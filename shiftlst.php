...
if(isset($_GET['deleteid'])){
    $id=$_GET['deleteid'];
    //delete query  
    $sql="DELETE from `shiftname` where id_shift=$id";
...
<?php
  if(isset($_SESSION['shiftadd'])){
    ...
    unset($_SESSION['shiftadd']);
}
  
  ?>

<!--------- End Add Dialog Msg Modal --------->

<!---------  Edit Dialog Msg Modal --------->
<?php
  if(isset($_SESSION['shiftedt'])){
    ...
    <strong class='text-dark'>".$_SESSION['shiftedt']."</strong>
      ...
      unset($_SESSION['shiftedt']);
  }
  
  ?>

<!--------- End Edit Dialog Msg Modal --------->

<!---------  Delete Dialog Msg Modal --------->
<?php
  if($delete==true){
    echo "
          ...
          <strong class='text-dark'> Shift Deleted ID is: ".$id."</strong>
...
<!--------- End Delete Dialog Msg Modal --------->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title fs-5" id="exampleModalLabel">ADD NEW SHIFT</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action ="shiftadd.php" method="POST">

      <div class="modal-body row g-3">
      
      <div class="col-md-5">
    <label for="shiftname1" class="form-label" for="shiftname1" >Shift Name</label>
    <input type="text" class="form-control center"  name="shiftname" id="shiftname1" placeholder="Shift A" required>
  ...
  <div class="col-md-12 ">
    <button type="submit" name="addshiftname" class="btn btn-outline-primary ">Submit</button>
  </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Shift Data Table</h5>
              ...
              <table class="table">
                ...
                //select database data show in table    
                    $select_data="SELECT * FROM `shiftname`";
                    $result=mysqli_query($conn, $select_data);
                    while($row =mysqli_fetch_assoc($result)){
                        ?>
                    <tr>
                            <td scope='row'><?=$row['id_shift']?></td>
                            <td><?=$row['ShiftName']?></td>
                            <td><?php
                            if( $row['IsActive']==1){
                            ...
                            ?></td>
                            <td>
                            <button class='editbtn btn btn-sm btn-dark tblbtn'><a href='#editmodal?editid=<?=$row['id_shift']?>' class='tb' style="color:white;"><i class='bi bi-pencil-square'></i></a></button>
                            <button class='delete btn btn-sm btn-danger  tblbtn' ><a href='?deleteid=<?=$row['id_shift']?>' class='tb' style="color:white;"><i class='bi bi-trash'></i></a></button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title fs-5" id="exampleModalLabel">Edit Shift Name</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action ="shiftedit.php" method="POST">

      <div class="modal-body row g-3">
    <input type="hidden" class="form-control"  name="Id_number" id="Id_number" placeholder="Id Number" readonly>
  <div class="col-md-6">
    <label  class="form-label">Shift Name</label>
    <input type="text" class="form-control"  name="shiftname" id="shiftname" placeholder="Shift A" required>
  </div>
  <div class="form-check ">
